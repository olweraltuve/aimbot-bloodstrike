...
echo.
echo Updating PyTorch to stable build with CUDA 12.8 for RTX 5060 compatibility...
...
echo ===============================================
echo.
echo If CUDA functionality test passed, your RTX 5060 is now fully supported with CUDA 12.8!
echo The aimbot will use GPU acceleration on your RTX 5060.
echo.
